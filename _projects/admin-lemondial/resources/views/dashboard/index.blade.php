    ...
    <div class="col-xl-4">
        ...
        <a href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <div class="text-white fw-bold fs-2 mb-2 mt-5">Talent Scouting</div>
                <div class="fw-semibold text-white">Job seeker, Company, Job posts</div>
            </div>
            <!--end::Body-->
        </a>
    ...
    <div class="col-xl-4">
        ...
        <a href="#" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <div class="text-white fw-bold fs-2 mb-2 mt-5">Talent Recruitment</div>
                <div class="fw-semibold text-white">Dashboard, requests, reports</div>
            </div>
            <!--end::Body-->
        </a>
        <!--end::Statistics Widget 5-->
    ...
    <div class="col-xl-4">
        ...
        <a href="#" class="card bg-danger hoverable card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <div class="text-white fw-bold fs-2 mb-2 mt-5">Talent Management</div>
                <div class="fw-semibold text-white">Dashboard, requests, reports</div>
            </div>
            <!--end::Body-->
        </a>
        ...
        <div class="card card-xxl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold fs-3 mb-1">Blank Page</span>
                    <span class="text-muted mt-1 fw-semibold fs-7">Dashboard Homepage Here</span>
                </h3>
