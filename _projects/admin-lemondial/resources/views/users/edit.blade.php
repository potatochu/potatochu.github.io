...
<div class="row g-5 g-xl-8">
    ...
    <div class="col-xxl-12">
        <!--begin::Form-->
        <form id="create_form" class="form" method="POST" enctype="multipart/form-data" action="{{url('user/update/'.$user->users_id)}}">
            @csrf
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{url('assets/media/svg/avatars/blank.png')}}')">
                                ...
                                <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ $user->users_photo != '' ? url(env('PHOTO_PATH').'/'.$user->users_photo) : url('assets/media/avatars/blank.png')}})"></div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="users_full_name" class="form-control form-control-lg form-control-solid" placeholder="Full name" autocomplete="off" value="{{ $user->users_full_name }}" required/>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="tel" name="users_phone_number" class="form-control form-control-lg form-control-solid" placeholder="Phone number" autocomplete="off" value="{{ $user->users_phone_number }}"/>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="users_birthday" class="form-control form-control-lg form-control-solid" placeholder="Birthday" autocomplete="off" value="{{ $user->users_birthday }}"/>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
                        ...
                        <div class="col-lg-8 fv-row">
                            ...
                            <div class="d-flex align-items-center mt-3">
                                ...
                                <label class="form-check form-check-custom form-check-inline form-check-solid me-5">
                                    <input class="form-check-input" name="users_gender" type="radio" value="L" {{$user->users_gender == 'L' ? 'checked':''}}/>
                                    <span class="fw-semibold ps-2 fs-6">Male</span>
                                </label>
                                <!--end::Option-->
                                <!--begin::Option-->
                                <label class="form-check form-check-custom form-check-inline form-check-solid">
                                    <input class="form-check-input" name="users_gender" type="radio" value="P" {{$user->users_gender == 'P' ? 'checked':''}}/>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <select name="country_id" id="select_country" aria-label="Select a Country" data-control="select2" data-placeholder="Select a country" class="form-select form-select-solid form-select-lg fw-semibold">
                                ...
                                <option value="{{$item->country_id}}" {{$user->country_id == $item->country_id ? 'selected':''}}>{{$item->country_name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <!--end::Col-->
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <select name="states_id" id="select_state" aria-label="Select a state" data-control="select2" data-placeholder="Select a state" class="form-select form-select-solid form-select-lg fw-semibold">
                                ...
                                <option value="{{$item->states_id}}" {{$user->states_id == $item->states_id ? 'selected':''}}>{{$item->states_name}}</option>
                                @endforeach
                                @endisset
                            </select>
                        </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <select name="city_id" id="select_city" aria-label="Select a Country" data-control="select2" data-placeholder="Select a city" class="form-select form-select-solid form-select-lg fw-semibold">
                                ...
                                <option value="{{$item->city_id}}" {{$user->city_id == $item->city_id ? 'selected':''}}>{{$item->city_name}}</option>
                                @endforeach
                                @endisset
                            </select>
                        </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="number" name="users_postal_code" class="form-control form-control-lg form-control-solid" placeholder="Postal Code" autocomplete="off" value="{{ $user->users_postal_code }}"/>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="number" name="users_salary" class="form-control form-control-lg form-control-solid" placeholder="User's Salary" autocomplete="off" value="{{ $user->users_salary }}"/>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
                    {{-- <div class="row mb-6">
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                                <input class="form-check-input w-45px h-30px" type="checkbox" name="verify_profile" id="verify" {{$user->verify_profile ? '':''}}checked="checked">
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <textarea name="users_description" rows="3" class="form-control form-control-lg form-control-solid" placeholder="Users Description" autocomplete="off">{{ $user->users_description }}</textarea>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
            ...
            <div class="card card-xxl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-body border-top p-9">
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <select name="level_id" aria-label="Select Level" data-control="select2" data-placeholder="Select Level" class="form-select form-select-solid form-select-lg fw-semibold" required>
                                ...
                                <option value="{{$item->level_id}}" {{$user->level_id == $item->level_id ? 'selected':''}}>{{$item->level_name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="users_email" class="form-control form-control-lg form-control-solid" placeholder="Email" autocomplete="off" required value="{{ $user->users_email }}"/>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row position-relative" data-kt-password-meter="true">
                            <input type="password" name="users_password" class="form-control form-control-lg form-control-solid" placeholder="Update new password" autocomplete="off"/>
